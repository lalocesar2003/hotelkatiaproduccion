...
require_once __DIR__ . '/../config/preheaders.php';
// DEV: mostrar errores
...
<head>
	...
	<title>Hospedaje virgen del carmen</title>
...
if (is_array($validarCorreo) && isset($validarCorreo['email_encriptado']) && $validarCorreo['email_encriptado'] === $valor){
...
<script>
  window.userId = <?= (int)($_SESSION['id'] ?? 0) ?>;
</script>
