...
$mail->SMTPAuth = true;
$mail->Username = 'contactenos@hospedajevirgendelcarmen.com';
$mail->Password = '@Laloeselmejor5';
$mail->SMTPSecure = 'ssl'; // o 'ssl' si usas 465
$mail->Port = 465; // o 465 si usas ssl
//  $mail->SMTPDebug = 2;  // Modo de depuración detallado
// $mail->Debugoutput = 'html';
				$mail->setFrom('contactenos@hospedajevirgendelcarmen.com', 'Hospedaje Virgen del Carmen');


				$mail->addReplyTo('contactenos@hospedajevirgendelcarmen.com', 'Hospedaje Virgen del Carmen');
					...
					$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
							...
							<center>
								...
								<img style="padding:20px; width:10%" src="http://xn--dueo-iqa.site/wp-content/uploads/2025/09/LOGOVIRGENDELCARMEN8-3.png">
...
$mail->Debugoutput = 'html';
				...
				$mail->Subject = "Tiene una nueva consulta desde el formulario de contacto";

				$mail->addAddress("contactenos@hospedajevirgendelcarmen.com");
